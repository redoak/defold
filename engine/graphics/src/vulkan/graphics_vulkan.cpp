...
namespace dmGraphics
{
    ...
    SetRenderTargetAttachmentsParams::SetRenderTargetAttachmentsParams()
    {
        memset(this, 0, sizeof(*this));
        for (int i = 0; i < MAX_BUFFER_COLOR_ATTACHMENTS; ++i)
        {
            m_ColorAttachmentLoadOps[i]  = ATTACHMENT_OP_DONT_CARE;
            m_ColorAttachmentStoreOps[i] = ATTACHMENT_OP_STORE;
        }
    }
...
bail:
    ...
    void VulkanSetPipelineState(HContext _context, const PipelineState* ps)
    {
        VulkanContext* context     = (VulkanContext*) _context;
